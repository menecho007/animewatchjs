...
function nav(path) {
    ...
    <a href="https://github.com/menecho007/watchanimejs/" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'OpenSourced Code'}">
