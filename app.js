...
function nav(path) {
	var html = "";
	html += `<a href="https://an1m3-w4tch3rs.me" class="mdui-typo-headline folder">${document.siteName}</a>`;
    ...
    <a href="https://github.com/menecho007/watchanimejs/" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'OpenSourced Code - github'}">
...
function file_video(path){
	...
	if (/(iPhone|iPad|iPod|iOS|Android)/i.test(navigator.userAgent)) {
		...
		<li class="mdui-menu-item"><a href="intent:${url}#Intent;package=com.mxtech.videoplayer.pro;S.title=${path};end" class="mdui-ripple">MX Player Pro</a></li>
                <li class="mdui-menu-item"><a href="intent:${url}#Intent;package=com.newin.nplayer.pro;" class="mudi-ripple">NPlayer </a></li> 
