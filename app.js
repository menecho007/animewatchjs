...
function nav(path) {
    ...
    <a href="https://github.com/menecho007/watchanimejs" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Open Sourced On Github'}">
...
function file_video(path){
	...
	var playBtn = `<a class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent" href="potplayer://${url}"><i class="mdui-icon material-icons">&#xe038;</i>Play in potplayer (Browser Playback not Supported)</a>`;
	if (/(iPhone|iPad|iPod|iOS|Android)/i.test(navigator.userAgent)) {
	    playBtn = `	<a class="mdui-btn mdui-btn-raised mdui-ripple mdui-color-theme-accent" href="intent:${url}#Intent;package=com.newin.nplayer.pro;S.title=${path};end"><i class="mdui-icon material-icons">&#xe039;</i>Play in nplayer (Browser Playback not Supported)</a>`;
	}
	var content = `
<div class="mdui-container-fluid">
	...
	<!-Fixed label->
	<div class="mdui-textfield">
	  <label class="mdui-textfield-label">Download link/Stream Link</label>
...
//# sourceMappingURL=/sm/bae59244a322487ab3a1210a1994f5542665aad9a3f636b984f87cf0463b6234.map
